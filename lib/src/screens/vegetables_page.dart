...
class VegetablesPage extends StatelessWidget {
  ...
  Future<List<Product>> fetchVegetables() async {
    try {
      final response = await http.get(Uri.parse('${ApiConfig.productsUrl}?category=vegetables'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Vegetables', style: logoWhiteStyle),
      ),
